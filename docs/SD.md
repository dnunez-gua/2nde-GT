...
10. On souhaite connaître le nombre d'entrée réalisées par les films français de cette liste. Dans la cellule E33, écrivez =SOUS.TOTAL(9;E8:E32) (cette fonction permet de calculer la somme de la colonne E, mais seulement pour les films filtrés). La cellule devrait afficher 12,40, soit 12,40 millions d'entrées.
11. Supprimez le filtre sur la nationalité (vous devez à nouveau voir toutes les nationalités), puis triez la colonne sortie par date.  Les trois premiers films affichés devraient être Adieu les Cons, Conjuring 3: The Devil Made Me Do It, Cruella.
12. Le premier de ces films est sorti en 2020. Pourquoi est-il affiché dans cette liste qui concerne l'année 2021 ?
13. On veut connaître, parmi les films des États-Unis sortis en 2021, quels sont les trois films ayant réalisé le plus d'entrée.
